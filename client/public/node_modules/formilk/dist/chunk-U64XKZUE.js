...
function formilk({ width, color1, color2, contrast }) {
  color1 = contrast ? "#fff" : color1;
  return /* @__PURE__ */ _jsx("host", {
    shadowDom: true
  }, /* @__PURE__ */ _jsx("svg", {
    viewBox: "0 0  220 70.841",
    width
  }, /* @__PURE__ */ _jsx("path", {
...
formilk.styles = css`svg {
        max-width: 100%;
        display: block;
    }`;
var Formilk = c(formilk);
custom_elements_default.define("formilk", Formilk);
