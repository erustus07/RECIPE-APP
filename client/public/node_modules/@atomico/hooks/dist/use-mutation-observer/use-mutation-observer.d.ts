 ...
 */
export function useMutationObserver(ref: import("atomico").Ref, observe: MutationCallback, config?: MutationObserverInit): void;
/**
 * create an instance of MutationObserver for the given reference
 ...
 */
export function useMutationObserverState(ref: import("atomico").Ref, config?: MutationObserverInit): MutationRecord[];
